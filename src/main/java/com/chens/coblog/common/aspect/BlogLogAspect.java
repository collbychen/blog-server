package com.chens.coblog.common.aspect;
...
public class BlogLogAspect {
    ...
    @Around("execution(public * com.chens.coblog.api.front..*.*(..)) && !@annotation(org.springframework.web.bind.annotation.ModelAttribute)")
