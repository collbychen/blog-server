...
import cn.coblog.filter.JwtAuthenticationFilter;
import cn.coblog.filter.JwtLoginFilter;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .anyRequest()
                .authenticated();
        http.addFilterAfter(new JwtLoginFilter("/login", authenticationManager()),
